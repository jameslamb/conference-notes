...
* feature stores reuse your existing infra in your cloud environment
...
* all of these projects are using Arrow in some way
    - Spark
    - BigQuery
    - Parquet
    - Dremio
...
* problems solved by feature store
    - business metrics were a function of both rules and ML systems
